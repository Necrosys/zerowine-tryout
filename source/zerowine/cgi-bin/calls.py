...
#	"ws2_32\.gethostbyname":"",
	"ws2_32\.WSCInstallProvider":"/* Suspicious behavior: Install transport provider without user interaction, Possible malware prefix: Trojan, Possible false positive: YES */\n",
...
JUNK_CALLS = ['L"Software\\\\\\\\Microsoft\\\\\\\\Windows\\\\\\\\CurrentVersion\\\\\\\\ThemeManager',
	...
	'RegQueryValueEx.*L"MS Shell Dlg 2"',
...
#	'RegOpenKeyExW.*L"Drivers32",',
	...
	'RegQueryValueW.*L"800\\\\\\\\win32"',
	'RegQueryValueW.*L"2\\\\\\\\win32"',
	'RegQueryValueW.*L"0\\\\\\\\win32"',
